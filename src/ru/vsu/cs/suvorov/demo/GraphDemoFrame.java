package ru.vsu.cs.suvorov.demo;
...
import ru.vsu.cs.suvorov.Graph;
import ru.vsu.cs.suvorov.GraphAlgorithms;
import ru.vsu.cs.suvorov.GraphUtils;
    ...
    public GraphDemoFrame() {
        ...
        buttonCreateGraph.addActionListener(e -> {
            try {
                ...
                Class clz = Class.forName("ru.vsu.cs.suvorov." + className);
